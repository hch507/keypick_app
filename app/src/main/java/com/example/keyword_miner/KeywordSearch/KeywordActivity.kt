...
//        keywordViewModel.currentRelData.observe(this, Observer{
//            Log.d(TAG, "KeywordActivity - onCreate() - called ${it}")
//            binding.keyword.text = it.get(0).relKeyword
//            binding.pcClick.text = it.get(0).monthlyPcQcCnt
//            binding.moClick.text = it.get(0).monthlyMobileQcCnt
//        })
//
//        keywordViewModel.currentBlogDate.observe(this, Observer{
//            PeriodList=it
//            setChartView(binding)
//        })
//
//        keywordViewModel.currentMonthCnt.observe(this, Observer{
